...
public class AcademicSessionController {
    ...
    public ResponseEntity<?> getAll(
        ...
        Page<com.edupaste.payloads.AcademicSessionResponse> pagedData = service.getAll(PageRequest.of(page - 1, limit));
        PagedResponse<com.edupaste.payloads.AcademicSessionResponse> response = new PagedResponse<>(
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAnyAuthority('SCHOOL_ADMIN')")
    public ResponseEntity<?> update(@PathVariable UUID id, @RequestBody AcademicSessionRequest request) {
        Map<String, Object> response = new HashMap<>();
        response.put("success", true);
